function Dataset_out = Build_Dataset_Monthly(Spec, Haver_API_key)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Data = haver_multiple(Haver_API_key, Ticker{1}, Label{1});
Data_d = retime(Data, 'monthly', 'mean');

Data_weekly = haver_multiple(Haver_API_key, Ticker{2}, Label{2});
